...
type OrganizationServiceClient interface {
	...
	GetOrgList(ctx context.Context, in *GetOrgListMessage, opts ...grpc.CallOption) (*GetOrgListResponse, error)
}
...
func (c *organizationServiceClient) GetOrgList(ctx context.Context, in *GetOrgListMessage, opts ...grpc.CallOption) (*GetOrgListResponse, error) {
...
type OrganizationServiceServer interface {
	// Menu navigation endpoint
	GetOrgList(context.Context, *GetOrgListMessage) (*GetOrgListResponse, error)
...
func (UnimplementedOrganizationServiceServer) GetOrgList(context.Context, *GetOrgListMessage) (*GetOrgListResponse, error) {
...
func _OrganizationService_GetOrgList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).GetOrgList(ctx, req.(*GetOrgListMessage))
	}
...
var OrganizationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api-gateway/proto/organization/organization.proto",
}
