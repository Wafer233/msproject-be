...
func (x *ProjectMessage) Reset() {
	*x = ProjectMessage{}
	mi := &file_api_gateway_proto_project_project_service_proto_msgTypes[0]
...
func (*ProjectMessage) Descriptor() ([]byte, []int) {
	return file_api_gateway_proto_project_project_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProjectListRequest) Reset() {
	*x = ProjectListRequest{}
	mi := &file_api_gateway_proto_project_project_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectListRequest) Descriptor() ([]byte, []int) {
	return file_api_gateway_proto_project_project_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ProjectListResponse) Reset() {
	*x = ProjectListResponse{}
	mi := &file_api_gateway_proto_project_project_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectListResponse) Descriptor() ([]byte, []int) {
	return file_api_gateway_proto_project_project_service_proto_rawDescGZIP(), []int{2}
}
...
var File_api_gateway_proto_project_project_service_proto protoreflect.FileDescriptor

const file_api_gateway_proto_project_project_service_proto_rawDesc = "" +
	"\n" +
	"/api-gateway/proto/project/project_service.proto\x12\x12project.service.v1\"\x82\b\n" +
...
var (
	file_api_gateway_proto_project_project_service_proto_rawDescOnce sync.Once
	file_api_gateway_proto_project_project_service_proto_rawDescData []byte
)

func file_api_gateway_proto_project_project_service_proto_rawDescGZIP() []byte {
	file_api_gateway_proto_project_project_service_proto_rawDescOnce.Do(func() {
		file_api_gateway_proto_project_project_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_gateway_proto_project_project_service_proto_rawDesc), len(file_api_gateway_proto_project_project_service_proto_rawDesc)))
	})
	return file_api_gateway_proto_project_project_service_proto_rawDescData
}

var file_api_gateway_proto_project_project_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_gateway_proto_project_project_service_proto_goTypes = []any{
...
var file_api_gateway_proto_project_project_service_proto_depIdxs = []int32{
...
func init() { file_api_gateway_proto_project_project_service_proto_init() }
func file_api_gateway_proto_project_project_service_proto_init() {
	if File_api_gateway_proto_project_project_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_gateway_proto_project_project_service_proto_rawDesc), len(file_api_gateway_proto_project_project_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_gateway_proto_project_project_service_proto_goTypes,
		DependencyIndexes: file_api_gateway_proto_project_project_service_proto_depIdxs,
		MessageInfos:      file_api_gateway_proto_project_project_service_proto_msgTypes,
	}.Build()
	File_api_gateway_proto_project_project_service_proto = out.File
	file_api_gateway_proto_project_project_service_proto_goTypes = nil
	file_api_gateway_proto_project_project_service_proto_depIdxs = nil
}
